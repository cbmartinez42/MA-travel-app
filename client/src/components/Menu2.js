...
const history = useHistory();
  ...
  const adminPages = [{'text':'Home Page','menuPath':'home'},{'text':'Browse Tours','menuPath':'browse'}, {'text':'Admin Tasks','menuPath':'admin'}, {'text':'Add Tours','menuPath':'touradmin'}, {'text':'Add Operator','menuPath':'Operatoradmin'}, {'text':'Tour Page TEMP','menuPath':'tour'},{'text':'Log Out','menuPath':'login'}];
