          ...
          <Grid container spacing={1} alignContent="center">
              <Grid container spacing={1} className='dev-container'>
                    <Grid item xs={12} md={6} className='dev-about'>
                        <Link to={{ pathname: 'https://cbmartinez42.github.io/cmartinez-portfolio-react/'}} target="_blank" rel="noopener noreferrer">
                    ...
                    <Grid item xs={12} md={6} className='dev-about'>
                        <Link to={{pathname: 'https://mark-artim.github.io/portfolio2/'}} target="_blank" rel="noopener noreferrer">
                            <h2>Mark Artim</h2>
                        </Link>
                    ...
                    <Grid item xs={12} md={6} className='dev-about'>
                        <Link to={{pathname: 'https://jayyousef.github.io/portfolio-June-2021/'}} target="_blank" rel="noopener noreferrer">
                            <h2>Jay Yousef</h2>
                        </Link>
